...
- Use [Reporting Bugs](/docs/project-management/reporting-bugs) if the installer or app shows an error
- Join our [Discord community](https://discord.gg/6kVJTEXYEp) with your OS, installer type, and any error details
