...
3. **Important**: Since this is an unsigned application, you'll see a security warning

#### Handling macOS Security (Unsigned Application)

When you first open Codex Editor, macOS will show a warning because the application isn't code-signed by Apple:

1. **First Launch**: Right-click the app and select "Open" (don't double-click)
2. Click "Open" in the security dialog
3. **Alternative Method**: 
   - Go to System Preferences → Security & Privacy → General
   - You'll see a message about Codex Editor being blocked
   - Click "Open Anyway"

**What "Unsigned" Means**: The application hasn't been submitted to Apple for notarization, which means Apple hasn't verified it. This doesn't mean it's unsafe, but macOS requires this extra step to run it.
...
**What "Unsigned" Means**: The application doesn't have a digital signature from a recognized certificate authority. Windows flags this as potentially risky, but it's safe to proceed.
