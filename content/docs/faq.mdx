...
Here you can find the answers to the most common questions about Codex Editor. If you can't find what you're looking for, check our documentation or reach out on [Discord](https://discord.gg/6kVJTEXYEp).
...
Join our Discord server: [discord.gg/6kVJTEXYEp](https://discord.gg/6kVJTEXYEp). You'll find active support from the Codex team and other users.
...
If issues persist, see our [initial setup guide](/docs/getting-started/initial-setup) or try [creating a new project](/docs/project-management/creating-project).
...
- Check this FAQ and our documentation first
...
**Still have questions?** Our documentation is constantly evolving to better serve you. If you can't find the answer you're looking for, don't hesitate to reach out on our [Discord community](https://discord.gg/6kVJTEXYEp).
