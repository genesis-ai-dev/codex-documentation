...
**Need more help?** Start with the [Troubleshooting guide](/docs/troubleshooting) for import and alignment issues, then join our [Discord community](https://discord.gg/6kVJTEXYEp) with your file type, importer used, steps taken, and any error details.
