...
description: Learn how to import various file formats into Codex Editor including Word documents, subtitles, structured texts, audio, and more
---
...
<Callout type="info">
Some importers below are marked **Round-trip export supported**, meaning you can export back to the original format after translating. Round-trip export is currently in beta — see [Export Formats](/docs/translation/exporting-project#export-formats) for details.
</Callout>
...
<Accordions>
<Accordion title="Troubleshooting Import Issues">
...
- For structured texts, confirm the file follows the expected format (USFM, SFM, etc.)
...
- [Learn about export options](/docs/translation/exporting-project)
...
<Accordions type="multiple">
  ...
  <Accordion title="How do I know which importer to use?">
    ...
    - **Specialized** importers for translation workflows
  </Accordion>

  <Accordion title="Can I import audio files?">
    Yes! Use the **Audio** importer in the "Import Your Content" wizard. It supports `.mp3`, `.wav`, `.m4a`, `.aac`, `.ogg`, `.webm`, and `.flac` files and handles large files via backend processing. See our [Audio Translation guide](/docs/translation/video-audio-translation) for more details.
  </Accordion>
...
**Need more help?** Complete the [Troubleshooting guide](/docs/troubleshooting) support form for import and alignment issues, then paste the generated template into [Discord](https://discord.gg/6kVJTEXYEp).
