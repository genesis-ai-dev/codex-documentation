...
To translate multiple verses at once:

1. Click the **Sparkle button** at the top of the interface
2. Select **"Empty cells with no content"** (these are your target translation cells)
3. Choose the type and number of verses (e.g., 4 verses)
4. The AI will autocomplete starting from verse 1 and onward (linearly, not random cells)

When presented with options, select your preferred translation. The AI learns from your choices.
