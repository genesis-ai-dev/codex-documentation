...
Edits are non-destructive. The original recording is preserved, and saving writes the edited audio as a new version, automatically converted to a compact format. Audio attachments share a 50 MB size limit.
