...
<Callout type="info">
Formats marked **Beta** are functional but still being refined — output may require manual review. Formats marked **Coming Soon** are visible in the interface but not yet fully implemented.
</Callout>
