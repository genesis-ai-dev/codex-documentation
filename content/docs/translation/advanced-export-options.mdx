...
description: Learn about all available export formats in Codex Editor including round-trip workflows for Word, InDesign, and other specialized formats
---
...
- **USFM** - Standard translation format
...
- **OBS Markdown** - Export story-based Markdown with images
...
```
Section 1
Translated text for the first segment.

Section 2
Translated text for the second segment.
```
...
\h Document Title
\c 1
\v 1 Translated text for the first segment.
\v 2 Translated text for the second segment.
```
...
| **USFM** | No | Markers | No | Translation, Paratext |
...
### Workflow 2: Structured Text Publishing Pipeline
...
### Workflow 4: Multi-File Project

1. **Project:** 10 structured text files translated
2. **Export:**
   - **Individual:** USFM for each file (editorial review)
   - **Combined:** HTML for all files (web preview)
...
<Accordions type="multiple">
  ...
  <Accordion title="Which format is best for archival?">
    Use **Plain Text** for long-term archival (universal compatibility) and **USFM** for translations (industry standard). Keep original files as well.
  </Accordion>
  ...
  <Accordion title="How large can exported files be?">
    There's no strict limit, but very large files (100+ pages, 1000+ segments) may take longer to process. Consider splitting large files into smaller sections if performance is an issue.
  </Accordion>
</Accordions>
