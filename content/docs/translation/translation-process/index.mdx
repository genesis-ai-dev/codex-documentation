---
title: Badge Translation Process
description: Learn the step-by-step process for translating badges, including project setup, co-pilot configuration, and quality validation
---

## Badge Translation Process

### 1. Set Up the Project

<LoomVideo videoId="55d0393d4843496298f7a3b973ac5ce1" timestamp={0} title="Set Up the Project" />

- Begin by setting up the project for badge translation.
